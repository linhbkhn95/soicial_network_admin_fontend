...
export const crudGetList = (resource, pagination, sorts, filters) => ({
  type: CRUD_GET_LIST,
  payload: { pagination, sorts, filters },
  meta: {
    resource,
    fetch: GET_LIST,
    onFailure: {
...
export const crudGetAll = (resource, sorts, filters, maxResults, callback) => ({
  type: CRUD_GET_ALL,
  payload: { sorts, filters, pagination: { page: 1, perPage: maxResults } },
  meta: {
    resource,
    fetch: GET_LIST,
    onSuccess: {
...
export const crudGetManyReference = (
  ...
  payload: { target, id, pagination, sorts, filters, source },
  meta: {
    resource: reference,
    relatedTo,
