...
var crudGetList = exports.crudGetList = function crudGetList(resource, pagination, sorts, filters) {
  return {
    type: CRUD_GET_LIST,
    payload: { pagination: pagination, sorts: sorts, filters: filters },
    meta: {
      resource: resource,
...
var crudGetAll = exports.crudGetAll = function crudGetAll(resource, sorts, filters, maxResults, callback) {
  return {
    type: CRUD_GET_ALL,
    payload: { sorts: sorts, filters: filters, pagination: { page: 1, perPage: maxResults } },
    meta: {
      resource: resource,
      fetch: _dataFetchActions.GET_LIST,
      onSuccess: {
...
var crudCreate = exports.crudCreate = function crudCreate(resource, data, basePath) {
  ...
  var refresh = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : true;
  return {
    type: CRUD_CREATE,
    payload: { data: data },
    meta: {
...
var crudUpdate = exports.crudUpdate = function crudUpdate(resource, id, data, previousData, basePath) {
  ...
  var resolve = arguments[6];
  var reject = arguments[7];
  return {
    type: CRUD_UPDATE,
...
var crudGetManyReference = exports.crudGetManyReference = function crudGetManyReference(reference, target, id, relatedTo, pagination, sorts, filters, source) {
  return {
    type: CRUD_GET_MANY_REFERENCE,
    payload: { target: target, id: id, pagination: pagination, sorts: sorts, filters: filters, source: source },
    meta: {
      resource: reference,
      relatedTo: relatedTo,
