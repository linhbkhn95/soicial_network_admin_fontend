  ...
  (0, _createClass3.default)(CoreAdmin, [{
    ...
    value: function renderCore() {
      var _props = this.props,
          ...
          initActions = _props.initActions,
          _props$outsideRoutes = _props.outsideRoutes,
          outsideRoutes = _props$outsideRoutes === undefined ? [] : _props$outsideRoutes;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            outsideRoutes.map(function (route, index) {
              return _react2.default.createElement(_reactRouterDom.Route, {
                key: 'outsite-route-' + index,
                exact: route.exact,
                path: route.path,
                render: function render(props) {
                  return (0, _react.createElement)(route.component, (0, _extends3.default)({}, props));
                }
              });
            }),
            _react2.default.createElement(_reactRouterDom.Route, {
...
CoreAdmin.propTypes = {
  ...
  outsideRoutes: _propTypes2.default.array
};
