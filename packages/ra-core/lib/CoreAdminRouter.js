  ...
  (0, _createClass3.default)(CoreAdminRouter, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          _props$initApp = _props.initApp,
          initApp = _props$initApp === undefined ? function () {
        return null;
      } : _props$initApp,
          _props$initActions = _props.initActions,
          initActions = _props$initActions === undefined ? [] : _props$initActions,
          dispatch = _props.dispatch;

      if (typeof initApp === 'function') initApp();
      console.log('initAction ', initActions, ' accessToken ' + localStorage.getItem('accessToken'));
      if (Array.isArray(initActions)) initActions.forEach(function (action) {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          appLayout = _props2.appLayout,
          catchAll = _props2.catchAll,
          children = _props2.children,
          customRoutes = _props2.customRoutes,
...
exports.default = (0, _compose2.default)((0, _getContext2.default)({
  authProvider: _propTypes2.default.func
}), (0, _reactRedux.connect)(mapStateToProps, { userLogout: _authActions.userLogout, dispatch: function dispatch(v) {
    return v;
  } }))(CoreAdminRouter);