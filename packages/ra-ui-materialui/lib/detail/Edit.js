...
var EditView = function EditView(_ref2) {
  var actions = _ref2.actions,
      ...
      rest = (0, _objectWithoutProperties3.default)(_ref2, ['actions', 'basePath', 'children', 'className', 'defaultTitle', 'hasList', 'hasShow', 'record', 'prependBlock', 'redirect', 'resource', 'save', 'title', 'version', 'history']);
  ...
  return _react2.default.createElement(
    ...
    prependBlock ? prependBlock : _react2.default.createElement(
      _IconButton2.default,
      { style: { marginLeft: -14 }, onClick: function onClick() {
