...
var _raCore2 = _interopRequireDefault(_raCore);
...
var TextField = function TextField(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties3.default)(_ref, ['className', 'source', 'prefix', 'suffix', 'record', 'sourceData']);

  var finalSource = sourceData || source;
  var value = record && finalSource ? (0, _get2.default)(record, finalSource) : rest.value;
  return _react2.default.createElement(
    ...
    '' + (prefix || '') + (value !== undefined && value !== null ? value : '') + (suffix || '')
  );
};
