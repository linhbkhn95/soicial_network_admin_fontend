...
var ListView = function ListView(_ref2) {
  var _ref2$actions = _ref2.actions,
      ...
      title = _ref2.title,
      rest = (0, _objectWithoutProperties3.default)(_ref2, ['actions', 'filters', 'bulkActions', 'bulkActionButtons', 'pagination', 'children', 'prependBlock', 'className', 'classes', 'exporter', 'title']);
  var defaultTitle = rest.defaultTitle,
      version = rest.version,
      cardProps = rest.cardProps;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { key: version, style: { height: 'calc(100% - 64px)' } },
        _react2.default.createElement(
          'div',
