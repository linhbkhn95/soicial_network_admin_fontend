...
var createExBodyProps = function createExBodyProps(record, onRowClick) {
  if (onRowClick) {
    var _onClick = onRowClick(record);
    return {
...
var DatagridBody = function DatagridBody(_ref) {
  var basePath = _ref.basePath,
      ...
      rest = (0, _objectWithoutProperties3.default)(_ref, ['basePath', 'classes', 'className', 'resource', 'children', 'hasBulkActions', 'hover', 'ids', 'isLoading', 'data', 'selectedIds', 'styles', 'rowStyle', 'onToggleItem', 'version', 'onRowClick']);
  ...
  return _react2.default.createElement(
    ...
    ids.map(function (id, rowIndex) {
      ...
      return _react2.default.createElement(
        ...
        }, createExBodyProps(data[id], onRowClick)),
        children
      );
    })
  );
