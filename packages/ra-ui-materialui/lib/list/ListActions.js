...
var Actions = function Actions(_ref) {
  var bulkActions = _ref.bulkActions,
      ...
      hasExport = _ref.hasExport,
      hasImport = _ref.hasImport,
      basePath = _ref.basePath,
      selectedIds = _ref.selectedIds,
      onUnselectItems = _ref.onUnselectItems,
      showFilter = _ref.showFilter,
      dataProvider = _ref.dataProvider,
      rest = (0, _objectWithoutProperties3.default)(_ref, ['bulkActions', 'currentSort', 'className', 'resource', 'filters', 'displayedFilters', 'exporter', 'filterValues', 'hasCreate', 'hasExport', 'hasImport', 'basePath', 'selectedIds', 'onUnselectItems', 'showFilter', 'dataProvider']);
  return _react2.default.createElement(
    ...
    hasImport && _react2.default.createElement(_button.ImportButton, null),
    hasExport && _react2.default.createElement(_button.ExportButton, {
      resource: resource,
      sort: currentSort,
      filter: filterValues,
      exporter: exporter,
    ...
    hasCreate && _react2.default.createElement(_button.CreateButton, { basePath: basePath, variant: 'contained' })
  );
};
