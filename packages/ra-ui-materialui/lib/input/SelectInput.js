  ...
  (0, _createClass3.default)(SelectInput, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ['allowEmpty', 'choices', 'classes', 'className', 'input', 'isRequired', 'meta', 'options', 'resource', 'source', 'placeholder', 'optionValue', 'optionText']);
      ...
      var renderedChoices = [].concat((0, _toConsumableArray3.default)(choices));
      if (placeholder) {
        var _ref3;

        renderedChoices = [(_ref3 = {}, (0, _defineProperty3.default)(_ref3, optionValue, 'null'), (0, _defineProperty3.default)(_ref3, optionText, this.props.translate(placeholder)), (0, _defineProperty3.default)(_ref3, 'disabled', true), _ref3)].concat((0, _toConsumableArray3.default)(renderedChoices));
      }
      ...
      return _react2.default.createElement(
        ...
        (0, _extends3.default)({
          ...
          inputProps: {
            className: this.state.value === 'null' ? classes.placeholder : ''
          }
        }),
        this.addAllowEmpty(renderedChoices.map(this.renderMenuItem))
      );
    }
  }]);
  return SelectInput;
