...
var Button = function Button(_ref) {
  ...
  var _ref$alignIcon = _ref.alignIcon,
      ...
      color = _ref$color === undefined ? 'secondary' : _ref$color,
      label = _ref.label,
      _ref$size = _ref.size,
      size = _ref$size === undefined ? 'medium' : _ref$size,
      translate = _ref.translate,
      _ref$variant = _ref.variant,
      variant = _ref$variant === undefined ? 'contained' : _ref$variant,
      rest = (0, _objectWithoutProperties3.default)(_ref, ['alignIcon', 'children', 'classes', 'className', 'color', 'label', 'size', 'translate', 'variant']);
