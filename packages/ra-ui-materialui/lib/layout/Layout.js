...
var styles = function styles(theme) {
  ...
  return {
    ...
    content: (_content = {
      ...
      padding: 0
    }), (0, _defineProperty3.default)(_content, 'overflow', 'scroll'), _content)
  };
};
  ...
  (0, _createClass3.default)(Layout, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          noAppBar = _props.noAppBar,
          props = (0, _objectWithoutProperties3.default)(_props, ['appBar', 'children', 'classes', 'className', 'customRoutes', 'error', 'dashboard', 'logout', 'menu', 'notification', 'open', 'sidebar', 'title', 'contentStyle', 'noAppBar']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          !noAppBar && (0, _react.createElement)(appBar, { title: title, open: open, logout: logout }),
          _react2.default.createElement(
            'main',
            ...
            _react2.default.createElement(
              'div',
              { className: classes.content, style: (0, _extends3.default)({}, contentStyle) },
...
Layout.propTypes = {
  ...
  noAppBar: _propTypes2.default.bool
};
