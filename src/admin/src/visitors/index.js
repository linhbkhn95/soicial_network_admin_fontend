...
export const VehicleList = withStyles(listStyles)(({ classes, ...props }) => (
  <List
    {...props}
...
export const VehicleEdit = withStyles(editStyles)(({ classes, ...props }) => (
...
export const VehicleCreate = withStyles(editStyles)(({ classes, ...props }) => (
  <Create {...props}>
    <TabbedForm>
      <FormTab label="resources.customers.tabs.identity">
        <TextInput source="first_name" formClassName={classes.first_name} />
